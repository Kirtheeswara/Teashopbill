          ...
          <Card>
            <CardContent className="p-4 sm:p-6">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-4 sm:mb-6">
                <h2 className="text-lg sm:text-xl font-semibold text-secondary">Today's Menu Sales</h2>
                <div className="flex flex-wrap items-center gap-2 sm:gap-3">
                  ...
                  <Button
                    ...
                    className="bg-primary text-primary-foreground px-3 py-2 rounded-lg text-sm hover:bg-accent transition-colors flex-1 sm:flex-none"
